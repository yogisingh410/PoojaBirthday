...
const date = new Date(2017, 02, 05).getTime();
...
let timer = setInterval(function() {
    ...
    // display
    document.getElementById("timer").innerHTML ="<div class=\"days\"> \<div class=\"numbers\">" + days + "</div>days</div> \<div class=\"hours\"> \<div class=\"numbers\">" + hours + "</div>hours</div> \<div class=\"minutes\"> \<div class=\"numbers\">" + minutes + "</div>minutes</div> \<div class=\"seconds\"> \<div class=\"numbers\">" + seconds + "</div>seconds</div> \
</div>";
...
$(document).ready(function() {
    ...
    var box = $(".box"),
        ...
        ss = 0,
        upIMG,
        images = ["./images/section10/image01.JPG"]
    img = 0;
