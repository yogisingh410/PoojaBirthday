...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b10,#b20,#b21').stop();
	...
	$('#balloons_flying').click(function(){
		...
		$('.balloon-border1').animate({top:-700},15000);
		$('.balloon-border2').animate({top:-900},12000);
		$('.balloon-border3').animate({top:-1100},12000);
		$('#b1,#b4,#b5,#b7,#b9,#b20').addClass('balloons-rotate-behaviour-one');
		$('#b2,#b3,#b6,#b8,#b10,#b22').addClass('balloons-rotate-behaviour-two');
